...
function App() {
  ...
  return (
    <div className="flex justify-center items-center  w-screen h-screen">
      <div className="App flex flex-col w-[80%]  p-9 m-6 shadow-2xl">
        ...
        <div>
          <button
            className="border-1 border-slate-50 bg-blue-500 text-white p-1 py-2 rounded-md hover:bg-opacity-70 m-5 w-[20%] self-center shadow-xl  "
          ...
          <button
            className="border-1 border-slate-50   text-red-600 text-2xl p-1 py-2 rounded-md hover:bg-opacity-70 w-[20%] self-center mb-6"
